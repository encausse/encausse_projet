    ...
    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
      ...
      <thead>
        <tr>
          ...
          <th width="28%"><div align="center">Addresse, Contact</div></th>    
      ...
      <tbody>
       ...
       while($rs = mysqli_fetch_array($qsql))
       {
        ...
        {
          echo "<a href='patient.php?editid=$rs[patientid]' class='btn btn-sm btn-raised bg-green'>Edit</a><a href='viewpatient.php?delid=$rs[patientid]' class='btn btn-sm btn-raised bg-blush'>Supprimer</a> <hr>
