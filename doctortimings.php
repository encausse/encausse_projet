...
if(isset($_POST[submit]))
{
	if(isset($_GET[editid]))
	{
		...
		{
			echo "<script>alert('L'enregistrement Timings du docteur a été mis à jour avec succès...');</script>";
		}
		else
		{
...
<div class="container-fluid">
	<div class="block-header">
            <h2 class="text-center">Ajouter une plage horaire</h2>
   ...
   <form method="post" action="" name="frmdocttimings" onSubmit="return validateform()">
    <table class="table table-hover">
      <tbody>
		...
		?>      
        <tr>
          <td width="34%" height="36">Docteur</td>
