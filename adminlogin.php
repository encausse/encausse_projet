...
?></div>
    ...
    <div class="card">
        <h1 class="title"><span>systeme de gestion hospitaliere</span>Login <span class="msg">Connectez-vous pour démarrer votre session</span></h1>
        <div class="col-md-12">
    ...
    <div class="input-group"> <span class="input-group-addon"> <i class="zmdi zmdi-account"></i> </span>
                ...
                <div>
                    ...
                    <div class="text-center"> <a href="adminforgetpassword.php">Mot de passe oublie?</a></div>
                </div>
            </form>
        </div>
    </div>    
