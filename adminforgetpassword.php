...
if(isset($_POST['submit'])) {
    ...
    // Vérification si l'e-mail existe dans la table des administrateurs
    ...
    if(mysqli_num_rows($result) == 1) {
        ...
        $update_token = "UPDATE admin SET reset_token='$token' WHERE email='$email'";
        mysqli_query($con, $update_token);

        // Envoyer l'e-mail avec le lien de réinitialisation à l'administrateur
        $reset_link = "http://votresite.com/reset-password.php?token=$token&type=admin"; // URL où l'administrateur réinitialisera son mot de passe
        $to = $email;
        ...
        $err = "<div class='alert alert-danger'>L'adresse e-mail n'est pas enregistrée dans notre système pour les administrateurs.</div>";
    }
}
?>
...
<body class="theme-cyan login-page authentication">
    <div class="container">
        ...
        <div class="card">
            <h1 class="title"><span>Système de Gestion Hospitalière</span> Récupération de Mot de Passe Administrateur</h1>
            <div class="col-md-12">
