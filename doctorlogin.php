...
?></div>
    ...
    <div class="card">
        <h1 class="title"><span>systeme de gestion hospitalière</span>Login <span class="msg">Hello, Docteur!</span></h1>
        <div class="col-md-12">
    ...
    <div class="input-group"> <span class="input-group-addon"> <i class="zmdi zmdi-account"></i> </span>
                ...
                <div>
                    ...
                    <div class="text-center"> <a href="doctorforgetpassword.php">Mot de passe oublié?</a></div>
                </div>
            </form>
        </div>
    </div>    
