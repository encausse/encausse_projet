...
if(isset($_POST['submit'])) {
    ...
    // Vérification si l'e-mail existe dans la table patient
    ...
    if(mysqli_num_rows($result) == 1) {
        ...
        $update_token = "UPDATE patient SET reset_token='$token' WHERE email='$email'";
        mysqli_query($con, $update_token);

        // Envoyer l'e-mail avec le lien de réinitialisation à l'utilisateur
        $reset_link = "http://votresite.com/reset-password.php?token=$token&type=patient"; // URL où le patient réinitialisera son mot de passe
        $to = $email;
        ...
        $err = "<div class='alert alert-danger'>L'adresse e-mail n'est pas enregistrée dans notre système.</div>";
    }
}
?>
...
<div class="container">
    ...
    <div class="card">
        <h1 class="title"><span>Système de Gestion Hospitalière</span> Récupération de Mot de Passe</h1>
        <div class="col-md-12">
