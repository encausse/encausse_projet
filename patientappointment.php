...
<div class="wrapper col4">
    <div id="container">
        ...
        if(isset($_POST[submit]))
        {
           if(mysqli_num_rows($qsqlappointment) >= 1)
           {		
             echo "<h2>Rendez-vous déjà prévu pour ". date("d-M-Y", strtotime($_POST[appointmentdate])) . " " . date("H:i A", strtotime($_POST[appointmenttime])) . " .. </h2>";
         }
         else
         {
          if(isset($_SESSION[patientid]))
          {
             ...
             echo "<p class='text-center'>L'enregistrement du rendez-vous est en cours de traitement. Veuillez vérifier l'état du rendez-vous. </p>";
             echo "<p class='text-center'> <a href='viewappointment.php'>Afficher l'enregistrement de rendez-vous</a>. </p>";			
         }
         else
         {
             echo "<h2 class='text-center'>Rendez-vous pris avec succès..</h2>";
             echo "<p class='text-center'>L'enregistrement du rendez-vous est en cours de traitement. Veuillez attendre le message de confirmation. </p>";
             echo "<p class='text-center'> <a href='patientlogin.php'>Cliquez ici pour vous identifier</a>. </p>";	
         }
     }
 }
 else
                        ...
                        <div class="col-lg-7">
                            <div class="appointment">
                                ...
                                <form method="post" action="" name="frmpatapp" onSubmit="return validateform()"
                                    ...
                                    <ul class="row">
                                        ...
                                        <li class="col-sm-6">
                                            <label><input placeholder="Addresse" type="text" class="form-control"
                                        ...
                                        <li class="col-sm-6">
                                            <label>
                                             <input placeholder="ville" type="text" class="form-control" name="city" id="city" value="<?php echo $rspatient[city];  ?>"
                                        ...
                                        <li class="col-sm-6">
                                            <label>
                                                <input placeholder="Numéro de téléphone" type="text" class="form-control"
                            ...
                            ?>
                                   ...
                                   else
                                   {
                                    ?>
                                                <select name="select6" id="select6" class="selectpicker">
                                                    <option value="" selected="" hidden="">Selectionner un Genre</option>
                                                    <?php
                             ...
                             ?>
                                        ...
                                        <li class="col-sm-12">
                                            <button type="submit" class="btn" name="submit" id="submit">Prendre un rendez-vous </button>
                                        </li>
                                </form>
                            </div>
                        </div>
